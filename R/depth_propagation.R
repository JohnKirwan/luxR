...
#' converts it to \eqn{W\,m^{-2}\,nm^{-1}}{W m^-2 nm^-1}, and propagates it from its recorded reference depth
...
#'   (downwelling spectral irradiance at \code{depth}, in \eqn{W\,m^{-2}\,nm^{-1}}{W m^-2 nm^-1}). The
