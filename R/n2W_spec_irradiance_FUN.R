...
#'
#' @keywords internal
#' @param photons The spectral irradiance (in \eqn{W\,m^{-2}\,nm^{-1}} or
#'   \eqn{photons\,m^{-2}\,s^{-1}\,nm^{-1}}; see photon) at each wavelength bin.
...
#'   from \eqn{photons\,m^{-2}\,s^{-1}\,nm^{-1}} into \eqn{W\,m^{-2}\,nm^{-1}}.
#
