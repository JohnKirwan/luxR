...
#'
#' @keywords internal
#' @param photons The spectral irradiance (in W/m^2/nm or photons/m^2/s/nm; see photon) at each wavelength bin.
#' @param lambda The wavelength in nanometres (nm), taken from the midpoint value of irradiance bins.
#' @return A scalar representing the spectral irradiance values transformed from photons/m^2/s/nm into Watts/m^2/nm.
#
