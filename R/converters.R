...
#'
#' @param n      Photon count(s) per second per m^2 per nm.
#' @param lambda Wavelength(s) in nm.
#' @return Numeric vector of spectral irradiance in W/m^2/nm.
...
#'
#' @param W      Spectral irradiance in W/m^2/nm.
#' @param lambda Wavelength(s) in nm.
#' @return Numeric vector of photon counts per second per m^2 per nm.
#' @examples
#' W2photon(1, 555)
#' @export
...
#'   \item{\code{"umol"}}{PAR-band photon flux (400–700 nm) in \eqn{\mu}mol/s/m^2}
