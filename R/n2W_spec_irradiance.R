...
#'
#' @param value Spectral irradiance in \eqn{photons\,m^{-2}\,s^{-1}\,nm^{-1}}{photons m^-2 s^-1 nm^-1}
#'   (or molar units), or a
...
#'   (\eqn{\mu mol}, mmol, or \eqn{mol\,m^{-2}\,s^{-1}\,nm^{-1}}{mol m^-2 s^-1 nm^-1}) — specify
...
#'   \code{"photons"}.
#' @return Numeric vector of spectral irradiance in \eqn{W\,m^{-2}\,nm^{-1}}{W m^-2 nm^-1}, or a
...
#'
#' @param W          Spectral irradiance in \eqn{W\,m^{-2}\,nm^{-1}}{W m^-2 nm^-1}, or a \code{lux_spectrum}
